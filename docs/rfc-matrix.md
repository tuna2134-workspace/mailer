...
| 3207 | SMTP Service Extension for Secure SMTP over TLS | Proposed Standard | STARTTLS | current | 2487 | — | — | 7817 | partial | required | 7 | mail-smtp-server | starttls_resets_session_and_gates_auth | ACME resolver wired and post-TLS state reset; live handshake integration test pending |
| 4954 | SMTP Service Extension for Authentication | Proposed Standard | AUTH | current | 2554 | — | 3463 | 5248 | partial | required | 7 | mail-smtp-server,mail-postgres | parses_plain_initial_response;starttls_resets_session_and_gates_auth | TLS-only PLAIN and lockout implemented; SCRAM remains unimplemented |
...
| 2231 | MIME Parameter Value and Encoded Word Extensions | Proposed Standard | MIME | current | 2184 | — | 2045,2047,2183 | — | partial | required | 6 | mail-mime | planned:mime_params_2231 | Extended values and continuations remain unimplemented and are not claimed |
